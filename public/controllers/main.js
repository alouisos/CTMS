angular.module('MyApp')
  .controller('MainCtrl', ['$scope', 'Show', function($scope, Show) {
    ...
    $scope.sites = ['Addenbrookes Hospital - N01', 'Queen Elizabeth Hospital Birningham', 'Ipswich Hospital', 'Great Ormond Street Hospital', 'Imperial College Healthcare NHS Trust',
